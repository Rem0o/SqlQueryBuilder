...
namespace SqlQueryBuilder.Select
{
    public interface IQueryBuilderJoinOrSelect : IQueryBuilderSelectOnly
    {
        ...
        IQueryBuilderJoinOrSelect FullOuterJoin<T, U>(Expression<Func<T, object>> key1, Expression<Func<U, object>> key2, string table1Alias = null, string table2Alias = null);
    }
}
